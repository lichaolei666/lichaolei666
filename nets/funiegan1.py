...
class MSRB_Block(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv_3_2 = nn.Conv2d(in_channels=in_channels * 2, out_channels=out_channels * 2, kernel_size=3, stride=1, padding=1,
                                  bias=True)
        self.conv_3_3 = nn.Conv2d(in_channels=in_channels * 4, out_channels=out_channels * 4, kernel_size=3, stride=1, padding=1,
                                  bias=True)
        ...
        self.conv_5_2 = nn.Conv2d(in_channels=in_channels * 2, out_channels=out_channels * 2, kernel_size=5, stride=1, padding=2,
                                  bias=True)
        self.conv_5_3 = nn.Conv2d(in_channels=in_channels * 4, out_channels=out_channels * 4, kernel_size=5, stride=1, padding=2,
                                  bias=True)
        self.confusion = nn.Conv2d(in_channels=in_channels * 14, out_channels=out_channels, kernel_size=1, stride=1, padding=0,
                                   bias=True)
    ...
    def forward(self, x):
        ...
        output_3_3 = self.relu(self.conv_3_3(input_3))
        output_5_3 = self.relu(self.conv_5_3(input_3))
        output1 = torch.cat([output_3_3, output_5_3], 1)
        output2 = torch.cat([output1, input_2, input_3], 1)
